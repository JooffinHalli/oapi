...
import type { OneOf, AllOf } from './utilTypes';
...
export namespace Schemas {
  ...
  export type RoutedCar = {
    ...
    transportation_info?: null | OneOf<
  ...
  export type EventInfo = AllOf<
    ...
    | {
      ...
      is_special_name?: boolean
      add_method?: null | OneOf<
        | Schemas.MethodInfo
      >
      remove_method?: null | OneOf<
        | Schemas.MethodInfo
      >
      raise_method?: null | OneOf<
        | Schemas.MethodInfo
      >
  ...
  export type PropertyInfo = AllOf<
    ...
    | {
      ...
      can_read?: boolean
      can_write?: boolean
      get_method?: null | OneOf<
        | Schemas.MethodInfo
      >
      set_method?: null | OneOf<
        | Schemas.MethodInfo
      >
    }
  >
  ...
  export type LoadView = {
    ...
    >
    unloading?: null | OneOf<
      | Schemas.LoadPointViewForOrder
    >
    cargo?: null | OneOf<
      | Schemas.LoadCargo
    >
    transport?: null | OneOf<
  ...
  export type Organization = {
    ...
    name?: null | string
    ownership?: number
    residency?: null | OneOf<
      | Schemas.Residency
    >
    inn?: null | string
    phone?: null | string
    extra_phone?: null | number
    docs_address?: null | OneOf<
  ...
  export type DealView = {
    ...
    trailer?: null | OneOf<
      | Schemas.TruckView
    >
    semi_trailer?: null | OneOf<
      | Schemas.TruckView
    >
    document_info?: null | OneOf<
  ...
  export type PayDocsView = {
    documents_copies?: null | OneOf<
      | Schemas.DocumentStatusInfoView
    >
    documents_original?: null | OneOf<
      | Schemas.DocumentStatusInfoView
    >
    documents_original_track?: null | OneOf<
  ...
  export type RequisiteView = {
    ...
    is_active?: boolean
    legal_address?: null | OneOf<
      | Schemas.FirmAddressView
    >
    post_address?: null | OneOf<
      | Schemas.FirmAddressView
    >
  ...
  export type CountersView = {
    in_progress?: null | OneOf<
      | Schemas.OrderCounter
    >
    reconciliation?: null | OneOf<
      | Schemas.OrderCounter
    >
    completed?: null | OneOf<
      | Schemas.OrderCounter
    >
    payments?: null | OneOf<
      | Schemas.OrderCounter
  ...
  export type DealViewForAtiTrucker = {
    ...
    extra_document_type?: null | OneOf<
      | Schemas.DocumentType
    >
    ...
    tracker_cargo_owner_access?: null | OneOf<
    ...
    >
    cargo_owner_agent?: null | OneOf<
      | Schemas.AgentRmqModel
    >
    carrier_agent?: null | OneOf<
      | Schemas.AgentRmqModel
    >
    rate_total?: number
    ...
    is_pass_through?: boolean
    previous_driver?: null | OneOf<
      | Schemas.DriverRmqModel
    >
    previous_truck?: null | OneOf<
      | Schemas.TruckInfoRmqModel
    >
    previous_trailer?: null | OneOf<
      | Schemas.TruckInfoRmqModel
    >
    previous_semitrailer?: null | OneOf<
      | Schemas.TruckInfoRmqModel
    >
  ...
  export type DealStatusView = {
    ...
    status?: Schemas.DealState
    deal_kind?: Schemas.DealKinds
    inwork_status?: null | OneOf<
      | Schemas.InWorkStatus
    >
    tracker_offer_status?: null | OneOf<
  ...
  export type MapsFilterRequest = {
    zoom_square_request?: null | OneOf<
      | Schemas.GeoSquare
    >
    role?: null | OneOf<
      | Schemas.OrderRole
  ...
  export type GeoSquare = {
    south_west?: null | OneOf<
      | Schemas.GeoPair
    >
    north_east?: null | OneOf<
      | Schemas.GeoPair
    >
    zoom?: number
  }
